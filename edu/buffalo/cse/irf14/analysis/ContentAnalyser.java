...
public class ContentAnalyser implements Analyzer {
	...
	public static final String[] contentFilters = {TokenFilterType.STOPWORD.name(), TokenFilterType.NUMERIC.name(), TokenFilterType.SPECIALCHARS.name(), TokenFilterType.SYMBOL.name(), TokenFilterType.STEMMER.name()};
